...
module.exports = class {
	...
	async run (guild) {        
		...
		const logsEmbed = new Discord.MessageEmbed()
			.setAuthor(`${this.client.user.username} - guildCreate Logs`, this.client.user.displayAvatarURL())
			.setColor(this.client.config.embed.color)
			.setThumbnail(guild.iconURL())
			.addField(`${this.client.emojisPersonalizados.success} Added Guild:`, `${guild.name}\n(${guild.id})`, true)
